...
if(!isset($_SESSION['admin'])==TRUE)
  ...
  $rsq = "SELECT * FROM `category`";

  $rsp = mysql_query($rsq,$con);

  $rsnr = mysql_num_rows($rsp);

  if(!$rsnr)
  {
    echo '<script type="text/javascript"> 
                 alert("First make category then you will be allow to make category !"); 
            ...
            <div class="content">
                <div class="container-fluid">
                    <div class="page-title">
                        ...
                        <form method="post" action="upload_subcategory_upload.php" >
                  ...
                  <div class="col-lg-12">
                     <div class="card">
                        ...
                        <div class="card-body card-block">
                          <div class="form-group"><label for="Category Name" class=" form-control-label">Make Subcategory Of :</label>
                     ...
                     <?php 
                       ...
                       $qforcategory = "SELECT category_name FROM category WHERE parent_id = 0";

                       $qforcategoryr = mysql_query($qforcategory,$con);

                       if($qforcategoryr)
                       {
                           echo "<select name='parent_category_name'>";

                           while($category_row = mysql_fetch_array($qforcategoryr))
                           {
                   ...
                   ?>
                             ...
                             <div class="form-group"><label for="Subcategory Name" class=" form-control-label">Subcategory Name</label><input type="text" name="subcategory_name" id="company" placeholder="Enter your subcategory name" class="form-control" required></div>

                           <div class="form-group"><label for="subcategory Description" class=" form-control-label">Subcategory Description</label><input type="text" name="subcategory_desc" id="vat" placeholder="About subcategory..." class="form-control" required></div>
