            ...
            <div class="content">
                <div class="container-fluid">
                    <div class="page-title">
                        <h3></h3>
                        <form method="post" action="upload_delivery_details.php">
            <div class="animated fadeIn">
               <div class="row">
                  <div class="col-lg-12">
                     <div class="card">
                        <div class="card-header"><strong>Delivery</strong><small> Form</small></div>
                        <div class="card-body card-block">
                            <div class="form-group"><label for="Category Name" class=" form-control-label"></label><input type="hidden" name="oid" id="company" placeholder="Enter Area name" value="<?php echo  $oid; ?>" class="form-control" required></div>
                          
                          <div class="form-group"><label for="Category Name" class=" form-control-label">Shipping Date</label><input type="date" name="shipping_date" id="company" placeholder="Enter Date" class="form-control" style="width:200px" required></div>
                           <div class="form-group"><label for="Category Description" class=" form-control-label">Delivery Status</label><input type="number" min="0" max="1" value="0"  name="delivery_status" id="vat" placeholder="Enter Delivery Status" class="form-control" style="width:100px" required></div>

                           <div class="form-group"><label for="Category Description" class=" form-control-label">Delivery Details</label><input type="text" name="delivery_detials" id="vat" placeholder="Enter Delivery Detials" class="form-control" style="width:100%" required></div>
