            ...
            <div class="content">
                <div class="container-fluid">
                    <div class="page-title">
                        <h3></h3>
                        <form method="post" action="upload_area.php">
                  ...
                  <div class="col-lg-12">
                     <div class="card">
                        ...
                        <div class="card-body card-block">
                          <div class="form-group"><label for="Category Name" class=" form-control-label">Area Name</label><input type="text" name="area_name" id="company" placeholder="Enter Area name" class="form-control" required></div>
                           <div class="form-group"><label for="Category Description" class=" form-control-label">Pincode</label><input type="text" name="pincode" id="vat" placeholder="Enter pincode..." class="form-control" required></div>
