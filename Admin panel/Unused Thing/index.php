                            ...
                            <div class="nav-dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-end nav-link-menu">
                                    <ul class="nav-list">
                                        ...
                                        <div class="dropdown-divider"></div>
                                        <li><a href="../login and registration/logout.php" class="dropdown-item"><i class="fas fa-sign-out-alt"></i> Logout</a></li>
                                    </ul>
                                </div>
                            </div>
                        </li>
                                ...
                                <div class="content">
                                    ...
                                    <div class="canvas-wrapper">
                                        <table class="table table-striped">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>/about.php <a href="#"><i class="fas fa-link blue"></i></a></td>
                                                    <td class="text-end">8,340</td>
                                                </tr>
                                                <tr>
                                                    <td>/special-promo.php <a href="#"><i class="fas fa-link blue"></i></a></td>
                                                    <td class="text-end">7,280</td>
                                                </tr>
                                                <tr>
                                                    <td>/products.php <a href="#"><i class="fas fa-link blue"></i></a></td>
                                                    <td class="text-end">6,210</td>
                                                </tr>
                                                <tr>
                                                    <td>/documentation.php <a href="#"><i class="fas fa-link blue"></i></a></td>
                                                    <td class="text-end">5,176</td>
                                                </tr>
                                                <tr>
                                                    <td>/customer-support.php <a href="#"><i class="fas fa-link blue"></i></a></td>
                                                ...
                                                <tr>
                                                    <td>/products-pricing.php <a href="#"><i class="fas fa-link blue"></i></a></td>
                                                ...
                                                <tr>
                                                    <td>/contact-us.php <a href="#"><i class="fas fa-link blue"></i></a></td>
                                                    <td class="text-end">1,509</td>
                                                </tr>
                                                <tr>
                                                    <td>/terms-and-condition.php <a href="#"><i class="fas fa-link blue"></i></a></td>
